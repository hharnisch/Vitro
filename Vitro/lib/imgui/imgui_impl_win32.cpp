...
struct ImGuiViewportDataWin32
{
	...
	ImGuiViewportDataWin32() { Hwnd = NULL; hGLRC = NULL; hDC = NULL;  HwndOwned = false;  DwStyle = DwExStyle = 0; }
	~ImGuiViewportDataWin32() { IM_ASSERT(Hwnd == NULL); if(hGLRC != NULL) wglDeleteContext(hGLRC); if(hDC != NULL) ReleaseDC(Hwnd, hDC); }
};
