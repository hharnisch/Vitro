...
namespace Vitro
{
	...
	template<typename N, typename O>
	constexpr Vector<2, N> operator*(const Matrix<2, 2, N>& m, const Vector<2, O>& v)
	{
	...
	template<typename N, typename O>
	constexpr Vector<2, N> operator*(const Vector<2, O>& v, const Matrix<2, 2, N>& m)
	{
	...
	template<typename N, typename O>
	constexpr Vector<3, N> operator*(const Matrix<3, 2, N>& m, const Vector<2, O>& v)
	{
		return {m[0].X * v.X + m[1].X * v.Y,
				m[0].Y * v.X + m[1].Y * v.Y,
				m[0].Z * v.X + m[1].Z * v.Y};
	...
	template<typename N, typename O>
	constexpr Vector<2, N> operator*(const Vector<3, O>& v, const Matrix<3, 2, N>& m)
	{
	...
	template<typename N, typename O>
	constexpr Vector<4, N> operator*(const Matrix<4, 2, N>& m, const Vector<2, O>& v)
	{
		return {m[0].X * v.X + m[1].X * v.Y,
				m[0].Y * v.X + m[1].Y * v.Y,
				m[0].Z * v.X + m[1].Z * v.Y,
	...
	template<typename N, typename O>
	constexpr Vector<2, N> operator*(const Vector<4, O>& v, const Matrix<4, 2, N>& m)
	{
	...
	constexpr Matrix<2, 2, F> Inverse(const Matrix<2, 2, N>& m)
	{
