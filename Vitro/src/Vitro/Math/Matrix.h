...
namespace Vitro
{
	...
	typedef Matrix<2, 2, float>			Float2x2, Matrix2;
	typedef Matrix<2, 3, float>			Float2x3, Matrix2x3;
	typedef Matrix<2, 4, float>			Float2x4, Matrix2x4;
	typedef Matrix<3, 2, float>			Float3x2, Matrix3x2;
	typedef Matrix<3, 3, float>			Float3x3, Matrix3;
	typedef Matrix<3, 4, float>			Float3x4, Matrix3x4;
	typedef Matrix<4, 2, float>			Float4x2, Matrix4x2;
	typedef Matrix<4, 3, float>			Float4x3, Matrix4x3;
	typedef Matrix<4, 4, float>			Float4x4, Matrix4;
