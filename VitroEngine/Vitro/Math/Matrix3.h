...
namespace Vitro
{
	...
	public:
		...
		template<typename O, VTR_IS_SCALAR(O)> inline Matrix<R, 3, N> operator+(O scalar) const
		{
		...
		template<typename O, VTR_IS_SCALAR(O)> inline Matrix<R, 3, N>& operator+=(O scalar)
		{
